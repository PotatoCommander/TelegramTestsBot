...
namespace Tg.Menus
{
    public class Menu
    {
        ...
        protected InlineKeyboardMarkup CreateMarkup()
        {
            ...
            foreach (var button in Buttons) markupButtons.Add(button.GetButton());
        ...
        public void ClickOnButton(CallbackQuery callback, ITelegramBotClient bot)
        {
            ...
            {
                if (callback.Data == button.buttonCallbackData)
        ...
        {
            if (PicUrl != null) await bot.SendPhotoAsync(chat.Id, PicUrl);
